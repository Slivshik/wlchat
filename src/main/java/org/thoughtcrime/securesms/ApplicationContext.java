  ...
  public void onCreate() {
    ...
    Thread.setDefaultUncaughtExceptionHandler(
        (thread, throwable) -> {
          ...
          String subject =
              "WL CHAT " + BuildConfig.VERSION_NAME + "-" + BuildConfig.FLAVOR + " Crash Report";
        ...
        () -> {
          synchronized (initLock) {
            try {
              ...
              // Run media cleanup for managed provider accounts
              MediaCleanupManager.runIfneeded(ApplicationContext.this);
            } catch (Exception e) {
