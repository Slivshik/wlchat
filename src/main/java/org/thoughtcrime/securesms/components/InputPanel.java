...
public class InputPanel extends ConstraintLayout
  ...
  public void setListener(final @NonNull Listener listener) {
    ...
    // Attach formatting toolbar to compose text
    if (formattingToolbar != null && composeText != null) {
      formattingToolbar.attachToEditText(composeText);

      // Listen for text selection changes
      composeText.addTextChangedListener(new android.text.TextWatcher() {
        @Override public void beforeTextChanged(CharSequence s, int start, int count, int after) {}
        @Override public void onTextChanged(CharSequence s, int start, int before, int count) {}
        @Override
        public void afterTextChanged(android.text.Editable s) {
          checkFormattingToolbarVisibility();
        }
      });

      composeText.setOnTouchListener((v, event) -> {
        composeText.post(() -> checkFormattingToolbarVisibility());
        return false;
      });
    }
  }

  private void checkFormattingToolbarVisibility() {
    if (formattingToolbar == null || composeText == null) return;
  ...
  public void dismissFormattingToolbar() {
