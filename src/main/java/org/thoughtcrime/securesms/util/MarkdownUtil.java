...
public class MarkdownUtil {
   ...
   * Delegates to TelegramMarkdownUtil which uses the collect-then-apply pattern
   * to avoid span corruption during SpannableStringBuilder construction.
   *
   * Supports:
   *   *bold*          → Bold
   *   _italic_        → Italic
  ...
  public static Spannable toTelegramMarkdown(Context context, String text) {
    ...
    return TelegramMarkdownUtil.toSpannable(text);
  }
}
